        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <Link href="https://www.tiktok.com/@MullenPeluqueros" className="flex justify-center items-center text-color3bs bg-gray-800 hover:text-gray-100 hover:bg-color3bs rounded-full transition duration-150 ease-in-out" aria-label="Tiktok">
              ...
              <li className="ml-4">
                <Link href="https://web.facebook.com/MullenPeluqueros" className="flex justify-center items-center text-color3bs bg-gray-800 hover:text-gray-100 hover:bg-color3bs rounded-full transition duration-150 ease-in-out" aria-label="Facebook">
              ...
              <li className="ml-4">
                <Link href="https://www.instagram.com/MullenPeluqueros/" className="flex justify-center items-center text-color3bs bg-gray-800 hover:text-gray-100 hover:bg-color3bs rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Mullen Peluqueros 2025. Todos los derechos reservados.</div>
